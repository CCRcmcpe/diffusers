...
parser = argparse.ArgumentParser(description="(Not so) simple example of a training script.")
parser.add_argument(
...
parser.add_argument("--save_interval", type=int, default=None,
                    help="Save weights every N steps. Overrides --save_interval_epochs.")
parser.add_argument("--save_interval_epochs", type=int, default=10, help="Save weights every N epochs.")
parser.add_argument("--save_min_steps", type=int, default=0, help="Start saving weights after N steps.")
parser.add_argument("--sample_interval", type=int, default=None, help="Save samples every N steps.")
parser.add_argument(
    "--mixed_precision",
    type=str,
    default="no",
